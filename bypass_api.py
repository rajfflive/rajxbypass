...
def bypass():
    ...
    async def send_and_poll():
        ...
        # Wait up to 20 seconds, polling every 1 second for new messages from bot
        for _ in range(20):
    ...
    try:
        ...
        if result:
            ...
            u['credits'] += 1
            u['total_used'] -= 1
            return jsonify({'status': False, 'error': 'Bot did not respond with destination link', 'developer': '@rajfflive'})

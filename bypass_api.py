...
CACHE_TTL = 86400
MAX_CACHE_SIZE = 2000
CACHE_ENABLED = True  # can be toggled via admin
    ...
    if original in bypass_cache:
        ...
        if time.time() - entry['ts'] < CACHE_TTL:
            ...
            if entry['bypassed'] == original:
                print(f"[CACHE] Invalid entry, deleting")
